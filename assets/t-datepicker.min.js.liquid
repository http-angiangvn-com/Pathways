...
/*var showMonths=settings.titleMonths[d.getMonth()].slice(0,settings.titleMonthsLimitShow);*/var showMonths= ((d.getMonth() > 8) ? (d.getMonth() + 1) : ('0' + (d.getMonth() + 1)));if(settings.replaceTitleMonths!==null){showMonths=settings.replaceTitleMonths+' '+check_num_10(d.getMonth()+1);}
...
var date_1=$('.t-input-check-in').val().split('/');
var date_2=$('.t-input-check-out').val().split('/');
$('body input[name="date_range"]').val(date_1[2]+'/'+date_1[1]+'/'+date_1[0] +'-'+date_2[2]+'/'+date_2[1]+'/'+date_2[0]);
if($('.t-input-check-in').val() != null && $('.t-input-check-in').val() != 'null' && $('.t-input-check-out').val() != null && $('.t-input-check-out').val() != 'null'){
	$('.t-date-check-in label').html($('.t-input-check-in').val() +' - '+$('.t-input-check-out').val());
}
else{
$('.t-date-check-in label').html('{{settings.home_search_placeholder_2}}');
}
